...
from .models import Cliente, Avaluo, DatosCliente, Mancomunado, ADR, ALR, Bien, Proposito, Servicio, Inmueble, DescripcionBien
...
admin.site.register(DescripcionBien)
